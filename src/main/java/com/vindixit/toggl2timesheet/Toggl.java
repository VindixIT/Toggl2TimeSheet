 ...
 */
package com.vindixit.toggl2timesheet;
...
public class Toggl {
     ...
     */
    public List<com.vindixit.toggl2timesheet.Client> getClients() {
        Client client = prepareClient();
        ...
        List<com.vindixit.toggl2timesheet.Client> clients = new ArrayList<com.vindixit.toggl2timesheet.Client>();
        if (data != null) {
	        for (Object obj : data) {
	            JSONObject entryObject = (JSONObject) obj;
	            clients.add(new com.vindixit.toggl2timesheet.Client(entryObject.toJSONString()));
	        }
        }
        return clients;
    }
     ...
     */
    public com.vindixit.toggl2timesheet.Client createClient(com.vindixit.toggl2timesheet.Client clientObject) {
        Client client = prepareClient();
        WebResource webResource = client.resource(CLIENTS);
        ...
        object = (JSONObject) JSONValue.parse(response);
        JSONObject data = (JSONObject) object.get(DATA);
        return new com.vindixit.toggl2timesheet.Client(data.toJSONString());
    }
     ...
     */
    public com.vindixit.toggl2timesheet.Client updateClient(com.vindixit.toggl2timesheet.Client clientObject) {
        Client client = prepareClient();
	 ...
	 * @return all clients
	 */
	public List<com.vindixit.toggl2timesheet.Client> getWorkspaceClients(long workspaceId) {
		Client client = prepareClient();
    ...
    private JSONObject createClientRequestParameter(com.vindixit.toggl2timesheet.Client client) {
        JSONObject object = new JSONObject();
